...
/**
 * Servlet implementation class SalesAgentOrderUpdate
 */
public class SalesAgentOrderUpdate extends HttpServlet {
	...
	private void getAllOrders(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("salesagent-order.jsp");
	...
	private void getSpecificOrder(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("salesagent-search-edit-order.jsp");
		rd.forward(request, response);
