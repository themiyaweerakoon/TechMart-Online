...
<form class="container" action="getCustomerLogin" method="post">
      ...
      <div class="col-12 col-md-8 col-lg-6 col-xl-5">
        <div class="card shadow-2-strong" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center" style="background-color: #FFE87C;">
            ...
            <h3 class="mb-5">CUSTOMER LOGIN</h3>
			...
			<div id="registerLink">
      			<a class="underlineHover" href="http://localhost:8080/techmart-online/register-customer.jsp">Not Registered?</a>
    		</div>
			<br/>
